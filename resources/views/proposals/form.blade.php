            ...
            <div class="Form-layout">
                ...
                <div class="Form-field Col-1_3">
                    ...
                    <div id="inputDisplay">
                        ...
                        <select name="line">
                            ...
                            <option value="{{ $line->subline }}">{{ $line->subline }} - {{ $line->line }}</option>
                            @endforeach
                            @endif
                        </select>
                    </div>
                ...
                <div class="Form-field">
                    ...
                    <div id="inputDisplay">
                        ...
                        <input class="" type="text" readonly id="disable" value="{{ $student->courses[0]->advisor->names }} {{ $student->courses[0]->advisor->first_lastname }}" class="campotexto" name="advisor">
                    </div>
                </div>
                ...
                <div class="Form-field">
                    ...
                    <div id="inputDisplay">
                        ...
                        <input type="text" readonly name="program" id="disable" value="{{ $student->program->name }}">
                    </div>
                </div>
                <div class="Form-field">
                    ...
                    <div id="inputDisplay">
                        ...
                        <input class="" readonly type="number" max="9" min="1" class="camponumero" id="disable" name="semester" value="{{ $student->semester }}">
                    </div>
                </div>
                <div class="Form-field Col-1_3">
            ...
            <div class="Members-div">
                ...
                <div class="Members-layout">
                    <ul>
                        ...
                        <li>{{ $loop->iteration }}. {{ $member->names }} {{ $member->first_lastname }} {{ $member->second_lastname }}</li>
                        @endforeach
                    </ul>
                </div>
            </div>
