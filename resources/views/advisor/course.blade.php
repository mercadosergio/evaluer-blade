    ...
    <div class="Layout">
        ...
        <section class="Activities">
            <div class="Post-title">
                ...
                <a class="button txt-white back-success move-right" href="{{ route('activities.create', ['courseId' => $course->id]) }}">Nueva</a>
            </div>
        ...
        <section class="Post">
            ...
            <div class="Post-content">
                <button class="Post-button button-active button txt-white back-primary" id="new-post">Publicar un anuncio</button>
                <form class="post_form" id="form-post" method="POST">
                    ...
                    <button type="submit" class="Post-button button txt-white back-primary" id="action">Publicar</button>
                </form>
            </div>
            ...
            <div class="Post-info">
                ...
                <div class="e1"><img class="Post-img--avatar" src="{{ asset('avatar/'. $post->avatar) }}" /></div>
