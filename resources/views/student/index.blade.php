...
@section('content')
    <section class="StudentModules">
        @if (isset($course))
            ...
            <a href="{{ route('student.team', ['courseId' => $course->id]) }}"
                class="button back-primary txt-white center">Inscribir grupo</a>
        ...
        @if (isset($course))
            @foreach ($course->posts as $post)
                ...
                <div class="Lesson-div">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt id eum quod ab molestiae debitis.
                        Maiores
                        rerum, facilis vel dignissimos dolor omnis, illum voluptas ullam, dolores nihil expedita! Aut,
                        iure.
                        Pariatur debitis itaque quae esse? Exercitationem maxime accusamus magni tempore soluta mollitia
                        iure
                        ipsa alias, tempora non deleniti doloremque veritatis perferendis unde impedit reprehenderit eum
                        nam
                        aliquam ad recusandae esse!
                        Optio, accusamus officia? Reiciendis accusantium vel, recusandae expedita quasi dolorem. Sunt
                        nisi
                        reiciendis eligendi unde accusamus consequatur dignissimos saepe minus necessitatibus ex
                        expedita nulla
                        placeat neque, ipsam maiores quaerat. Quam.
                        Accusantium nisi, animi laborum illo sunt reprehenderit nostrum maxime eius. Quasi pariatur,
                        vitae porro
                        quis fugiat cumque laborum in beatae minima ex corrupti quam enim maxime eligendi, atque
                        maiores.
                        Facere?
                        Mollitia veritatis error aspernatur nesciunt nulla totam. Amet nobis, accusantium, quae omnis
                        temporibus
